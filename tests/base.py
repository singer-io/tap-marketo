...
class MarketoBaseTest(unittest.TestCase):
    ...
    def get_type():
        ...
        return "platform.marketo"

    def get_properties(self, original: bool = True):
        """Configuration properties required for the tap."""
        return_value = {
            'start_date' : '2021-05-10T00:00:00Z',
            "endpoint": "TAP_MARKETO_ENDPOINT",
            "client_id": "TAP_MARKETO_CLIENT_ID",
            "client_secret": "TAP_MARKETO_CLIENT_SECRET",
        }
        if original:
            return return_value
    ...
    def setUp(self):
        missing_envs = [x for x in [os.getenv('TAP_marketo_TOKEN')] if x is None]
