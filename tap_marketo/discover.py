...
SMART_CAMPAIGNS_AUTOMATIC_INCLUSION = frozenset(["id", "createdAt", "updatedAt"])
...
def discover(client):
    ...
    streams.append(discover_catalog("smart_campaigns", SMART_CAMPAIGNS_AUTOMATIC_INCLUSION))
